/* client-src/50-admin-panel.js — 员工设置 AdminPanel */
    ...
    function AdminPanel(props) {
      ...
      var sessionRows = (snapshot.ids || []).map(function (id) { return snapshot.byId[id]; }).filter(function (row) { return row && sessionAgentPreset(row) === selectedId && !row.blank; }).sort(function (a, b) { return (b.updatedAt || 0) - (a.updatedAt || 0); });
